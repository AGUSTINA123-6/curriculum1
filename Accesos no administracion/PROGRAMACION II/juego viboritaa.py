...
pen.hideturtle()
pen.goto(0, 260)
pen.write("Puntuación: 0  Puntuación más alta: 0", align="center", font=("Georgia", 20, "normal"))
...
while True:
	...
	if head.xcor()>290 or head.xcor()<-290 or head.ycor()>290 or head.ycor()<-290:
		...
		pen.clear()
		pen.write("Puntuación: {}  Puntuación más alta: {}".format(score, high_score), align="center", font=("Arial", 22, "normal"))
	...
	if head.distance(food) <20:
		...
		pen.clear()
		pen.write("Puntuación: {}  Puntuación más alta: {}".format(score, high_score), align="center", font=("Georgia", 22, "normal"))
	...
	for segment in segments:
		...
		#actualizar el score display
			pen.clear()
			pen.write("Puntuación: {}  Puntuación mas alta: {}".format(score, high_score), align="center", font=("Georgia", 22, "normal"))
